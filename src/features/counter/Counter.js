...
import { increment, reset, resetAll } from '../../app/slices/counterSlice'
import './counter.css'
...
const Counter = () => {
  ...
  return (
    <div className="container m-3 mx-auto text-center">
      ...
      <div className="row">
        {
         console.log(counters.counters)|| Object.keys(counters.counters).map(key => (
              ...
              <div className="card text-center border-primary box-card">
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-end">
                    <button className="btn btn-danger btn-sm reset-counter" onClick={() => dispatch(reset(key))}>
                  ...
                  <div className="d-flex justify-content-center">
                    <div
                      ...
                      onClick={() => dispatch(increment(key))}
                    >
